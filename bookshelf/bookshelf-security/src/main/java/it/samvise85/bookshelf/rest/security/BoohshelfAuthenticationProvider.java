...
@Controller
public class BoohshelfAuthenticationProvider implements AuthenticationProvider {
	private static final Logger log = Logger.getLogger(BoohshelfAuthenticationProvider.class);
