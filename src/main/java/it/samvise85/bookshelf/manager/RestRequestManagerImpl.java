...
import it.samvise85.bookshelf.persist.repository.RestRequestRepository;
...
@Service
public class RestRequestManagerImpl extends AbstractPersistenceUnit<RestRequest> implements RestRequestManager {
	@Autowired
